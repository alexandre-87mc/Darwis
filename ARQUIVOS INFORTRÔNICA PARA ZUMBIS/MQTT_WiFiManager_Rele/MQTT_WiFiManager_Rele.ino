...
#define servidor_mqtt_porta       "12525"  //Porta do servidor (a mesma deve ser informada na variável abaixo)
#define servidor_mqtt_usuario     "icdqkoii"  //Usuário
#define servidor_mqtt_senha       "SjHUB5TiZaOI"  //Senha
...
WiFiClient Teste_Darwis;                                 //Instância do WiFiClient
PubSubClient client(Teste_Darwis);                       //Passando a instância do WiFiClient para a instância do PubSubClient
